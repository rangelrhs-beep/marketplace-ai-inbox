...
class QuestionRecord(Base):
    ...
    item_id = Column(String(120), nullable=True)
    ...
    answer_error_code = Column(String(120), nullable=True)
    answer_error_message = Column(Text, nullable=True)
    answer_blocked_at = Column(DateTime, nullable=True)
